...
<body>
    ...
    <a href="{{ url('/register/verify/' . $codconfirmar) }}">
...
<a href="{{asset('/inicio')}}" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #bbbfc3; font-size: 19px; font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 white;">
EmprendeVende
</a>
</td>
</tr>
...
EmprendeVende - Zona de Registros</p>
...
enlace en tu navegador: <span class="break-all" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; word-break: break-all;">
<a href="{{ url('/register/verify/' . $codconfirmar) }}" 
...
{{ url('/register/verify/' . $codconfirmar) }}</a>
</span></p>
...
<p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; line-height: 1.5em; margin-top: 0; color: #aeaeae; font-size: 12px; text-align: center;">© 2020 EmprendeVende. Todos los derechos reservados.</p>
