    ...
    <div class="container py-xl-4 py-lg-2">
        ...
        <h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">
            <div class="alert alert-info" role="alert">
                <span>M</span>étodos <span>D</span>e <span>P</span>ago </h3>
              </div>
        <!-- //tittle heading -->
        <div class="checkout-right">
            <!--Horizontal Tab-->
            <div id="parentHorizontalTab">
                <ul class="resp-tabs-list hor_1 .table-bordered">
                    <li>Pago Contra Entrega/Efectivo</li>
                    <li>Tarjeta Visa/Mastercard</li>
                    <li>Otro Metodo de Pago</li>
                            ...
                            <div class="checkbox">
                                <div class="check_box_one cashon_delivery">
                                    <label class="anim">
                                        ...
                                        <span> 
                                            También aceptamos tarjetas de crédito/débito a la entrega. Consulte con el agente.</span>
                                    </label>
                                </div>
                            ...
                            <div class="creditly-wrapper wthree, w3_agileits_wrapper">
                                <div class="credit-card-wrapper">
                                    <div class="first-row form-group">
                                        <div class="controls">
                                            <p class="text-muted">Contamos con el mejor mejor sistema de encriptación, Secure Sockets Layer (SSL) de 256-bit.
                                                Aceptamos tarjetas de Crédito (Visa, MasterCard, American Express y Diners Club) y Débito (Visa)
                                                Y si no estás satisfecho con tu producto, puedes devolverlo completamente gratis dentro de los 10 días naturales posteriores a la entrega (se aplican términos y condiciones)</p>
                    ...
                    <div>
                        <div class="vertical_post">
                            <form action="#" method="post">
                                <h5>Seleccione su Banco de Preferencia</h5>
                                <div class="swit-radio">
                                    <div class="check_box_one">
                                        <div class="radio_one">
                                            <label>
                                                <input type="radio" name="radio" checked="">
                                                <i></i>Scotiabank</label>
                                        </div>
                                    </div>
                                    <div class="check_box_one">
                                        <div class="radio_one">
                                    ...
                                    <div class="check_box_one">
                                        <div class="radio_one">
                                            <label>
                                                <input type="radio" name="radio">
                                                <i></i>Banco de Credito del Perú</label>
                                        </div>
                                    </div>
                                    <div class="check_box_one">
                                        <div class="radio_one">
                                ...
                                <div class="section_room_pay">
                                    <select class="year">
                                        <option value="">=== Otros Bancos ===</option>
