                                ...
                                <div class="col-xs-12 col-md-6">
                                    <div class="card mb-3" style="max-width: 540px;">
                                        <div class="row no-gutters">
                                            <div class="col-md-4">
                                                <img src="{{ asset('../storage/app/' . $value->imagen_f) }}" class="img-fluid" alt="{{$value->nombreProducto}}">
                                            </div>
                                            <div class="col-md-8">
                                                <div class="card-body">
                                            ...
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="card-body">
                                                        <h5 class="card-title">{{$value->nombreProducto}}</h5>
                                                        <p class="card-text">{{$value->marca}}</p>
                                                        <p class="card-text"><small class="text-muted">{{$value->descripcion}} 
                                                                </small></p>
                                                        <a href="single.html" class="btn btn-primary">Ver producto</a>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="row">
                        ...
                        @if (($key + 1) <= 8)
                            <div class="col-1"><a href=""><img src="{{ asset('../storage/app/' . $value->logo_img_empresa) }}" class="d-block w-100 img-fluid"></a>
                            </div>
                ...
                @if ($key + 1 >= 0)
                    @php 
                    array_push($datos,["orden" =>($key+1),"id"=>$value->idEmpresa,"nombre"=>$value->nombreEmpresa]);
                    if(count($datos)==8){
                        echo '
                            <div class="carousel-item">
                ...
                <div class="carousel-item">
                    <div class="container-xl">
                        <div class="row">
                            <div class="col-2"></div>
                            <div class="col-1"><a href=""><img src="images/m1.jpg" class="d-block w-100 img-fluid"></a>
                            </div>
                            <div class="col-1"><a href=""><img src="images/m1.jpg" class="d-block w-100 img-fluid"></a>
                            </div>
                            <div class="col-1"><a href=""><img src="images/m1.jpg" class="d-block w-100 img-fluid"></a>
                                ...
                                @foreach ($productos as $p)
                                    <div class="col-md-4 product-men mt-5">
                                        <div class="men-pro-item simpleCart_shelfItem">
                                            ...
                                            <img src="{{ asset('../storage/app/' . $p->imagen_f) }}"  class="img-fluid" alt="{{$p->nombreProducto}}">
