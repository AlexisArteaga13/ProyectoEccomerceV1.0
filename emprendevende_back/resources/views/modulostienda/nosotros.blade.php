...
@section('contenido')
    ...
    <div class="container justify-content-center">
        <img src="images/banner_emprede_vende.jpg" alt="">
	</div>
		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
				<div class="col-lg-6 welcome-left">
					<h3>Bienvenidos</h3>
					<h4 class="my-sm-3 my-2">Somos una empresa que promueve la digitalización de las Empresas, apoyando principalmente a los emprendedores como tú
                    que aun no cuentan con su tienda virtual. Buscamos ser el markeplace más grande en Perú, donde todos puedan ofrecer sus prodcutos
                    y donde todos encuentren lo que buscan en una sola página  </h4>
					<p>¡Vive la experiencia de pertenecer a esta familia!</p>
				</div>
