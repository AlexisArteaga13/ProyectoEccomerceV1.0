    <!-- Modal -->
    <div class="modal fade" id="exampleModalCenter{{$p->idPLAN,$metodo}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div style="text-align: center">
            <h1><font color="#004D7F" size=6>COMPRA TU PLAN</font></h1>
        </div>
        <div style="text-align: center">
            <h2><font color="#004D7F" size=6>{{$p->nombrePlan}}</font></h2>
        </div>
        <div style="text-align: center">
        ...
        <div style="text-align: center">
            <h2><font color="#004D7F" size= 4>Elige tu Método de Pago</font></h2>
        </div>
        <div style="text-align: center">
        <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1">
