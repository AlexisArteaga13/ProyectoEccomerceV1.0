...
@section('tituloadmin', 'Categorias')
@section('contenidoadministrable')
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-outline-warning"
                                                        data-toggle="modal" data-id="{{ $value->idCategoria }}"
                                                        data-nombre="{{ $value->nombreCategoria }}"
                                                        data-estado="{{ $value->estado }}"
                                                        data-target="#ModalEditar">Editar</button>
                                                    <button type="button" class="btn btn-outline-danger" data-toggle="modal"
                                                        data-target="#ModalEliminar-{{ $value->idCategoria }}">Eliminar</button>
                                                </td>

                                            </tr>
                                            @include('vistasadmin.categorias.modal')
                                        @endforeach
    ...
    <script src="{{ asset('jsadmin/categoria.js') }}"></script>
@endsection
